...
/**
 * Provides dynamic permissions for App project of different types.
 *
 * @ingroup gestion_tache
 *
 */
class AppProjectPermissions{
   ...
   *
   * @return array
   *   The AppProject by bundle permissions.
   *   @see \Drupal\user\PermissionHandlerInterface::getPermissions()
   */
  public function generatePermissions() {
    $perms = [];

    foreach (AppProject::loadMultiple() as $type) {
   ...
   *
   * @param \Drupal\gestion_tache\Entity\AppProject $type
   *   The AppProject type.
   *
   * @return array
   *   An associative array of permission names and descriptions.
   */
  protected function buildPermissions(AppProject $type) {
    $type_id = $type->id();
