...
use Drupal\gestion_tache\Entity\AppMemos;


/**
 * Provides dynamic permissions for App memos of different types.
 *
 * @ingroup gestion_tache
 *
 */
class AppMemosPermissions{
   ...
   *
   * @return array
   *   The AppMemos by bundle permissions.
   *   @see \Drupal\user\PermissionHandlerInterface::getPermissions()
   */
  public function generatePermissions() {
    $perms = [];

    foreach (AppMemos::loadMultiple() as $type) {
   ...
   *
   * @param \Drupal\gestion_tache\Entity\AppMemos $type
   *   The AppMemos type.
   *
   * @return array
   *   An associative array of permission names and descriptions.
   */
  protected function buildPermissions(AppMemos $type) {
    $type_id = $type->id();
