...
use Drupal\gestion_tache\Entity\AppClient;


/**
 * Provides dynamic permissions for App client of different types.
 *
 * @ingroup gestion_tache
 *
 */
class AppClientPermissions{
   ...
   *
   * @return array
   *   The AppClient by bundle permissions.
   *   @see \Drupal\user\PermissionHandlerInterface::getPermissions()
   */
  public function generatePermissions() {
    $perms = [];

    foreach (AppClient::loadMultiple() as $type) {
   ...
   *
   * @param \Drupal\gestion_tache\Entity\AppClient $type
   *   The AppClient type.
   *
   * @return array
   *   An associative array of permission names and descriptions.
   */
  protected function buildPermissions(AppClient $type) {
    $type_id = $type->id();
